...
declare module "Elementa/index" {
	...
	class AdditiveConstraint implements MasterConstraint {
		new(
			constraint1: SuperConstraint<number>,
			constraint2: SuperConstraint<number>
		): this;
	}
	...
	class MinConstraint implements MasterConstraint {
		new(
			constraint: SuperConstraint<number>,
			minConstraint: SuperConstraint<number>
		): this;
	}
	class MaxConstraint implements MasterConstraint {
		new(
			constraint: SuperConstraint<number>,
			maxConstraint: SuperConstraint<number>
		): this;
	}
	...
	class AnimatingConstraints extends UIConstraints {
		...
		setXAnimation(
			strategy: Animations,
			time: number,
			newConstraint: PositionConstraint,
			delay: number
		): this;
		setYAnimation(
			strategy: Animations,
